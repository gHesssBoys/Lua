...
while(nil)do;local i={}if(i.i)then;i.i=(i.i(i))end;end-- Simple block sstool and unluac --
...
gg.alert("Gunakan Game Guardian Versi ɢɢ Enjoyers untuk Menjalankan Script Ini\nUse My Game Guardian To Run Script", "[•] Download")
 revo.goURL("https://t.me/gHesss_Boys")
os.exit()
while true do
end
...
ProgressBar =  "║░░░░░░░░░░░░░░░║";for x = 1,16,1 do gg.sleep(150) ProgressBar = ProgressBar:gsub("░","▓",1);gg.toast(ProgressBar) end gg.sleep(150) gg.toast("Load Sukses")
Check_Login1 = gg.prompt({"⚠Enter Password⚠"},nil,{"000"}) or (function() while true do os.exit() end end)();Check_Login2 = Check_Login1[1] == "111" or (function() gg.alert("⚠ ERROR ⚠\n❎ Wrong Password ❎"); while true do os.exit() end end)() 
