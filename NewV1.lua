...
gg.toast(qmnb[2]["name"] .. "t.me/gHesss_Boys")
else 
...
xgjg = true end end 
if xgjg == true then 
gg.toast(qmnb[2]["name"] .. "Buka dengan sukses, modifikasi" .. xgsl .. "t.me/gHesss_Boys") 
else 
gg.toast(qmnb[2]["name"] .. "t.me/gHesss_Boys") 
end 
end 
